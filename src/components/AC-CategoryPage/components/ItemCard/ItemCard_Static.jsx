...
const ItemCard = props => {
  ...
  const isDeals = properties && properties.Deals_item == "Yes";
          ...
          <div className={`item-card-regular${isMobileState ? ` mobile` : ``}`}>
            <div
              className={
                ...
                (window.location.pathname.includes("/stores/giordano")) ? "product-title10" : "product-title" }
            ...
            {
              !isDeals && !isDining && typeof window !== undefined &&
              (!window.location.pathname.includes("/stores/giordano")) ? 
              <div
