...
import {
  ...
  handleSetFacetBread
} from "../../../src/redux/actions/facetActions";


import { facetImageGenerator } from "../../../src/functions/facetImageGenerator.js";
import classes from "./styles/BDFacets.module.css";

import { I18nContext } from "../../../src/i18n/index";
import OtherFacetsNewStore from "./OtherFacetsNewStore";
